    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-[#186f65] shadow-sm focus:ring-[#186f65]" name="remember">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-3 py-3 bg-button-primary">
                {{ __('Acessar') }}
            </x-primary-button>

            <x-secondary-button class="ms-3 py-3">
                <a href="{{ route('register') }}"> {{ __('Registre-se') }}</a>
            </x-secondary-button>
        </div>
    </form>
</x-guest-layout>
